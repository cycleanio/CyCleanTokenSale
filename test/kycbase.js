...
//       const kyc = await KYCBase.new([SIGNER_ADDR])
//       const payFallback = kyc.sendTransaction({from: accounts[1], to: kyc.address, value: 10000000})
...
//       const kyc = await KYCBase.new([SIGNER_ADDR])
//       const d = getKycData(buyer, 1, kyc.address, SIGNER_PK)
//       const buy = kyc.buyTokensFor(buyer, d.id, d.max, d.v, d.r, d.s, {from: accounts[0], value: 100})
//       await expect(buy).to.be.rejected
//     })
//   })
// })
